 ...
 * two fetches. Guatemala and Honduras both publish usable archives and are not
 * here yet; El Salvador and Nicaragua publish nothing that can be mirrored at
 * all, and no adapter can change that.
 */
...
export const SOURCES: Source[] = [OBSERVATORIO, PANAMACOMPRA, TIENDA_VIRTUAL];
